...
class AuthController extends GetxController{
  ...
  void signUpUsingFirebase({
    ...
    try {
      ...
      if (error.code == AppStrings.weekPasswordErrorCode) {
        message = AppStrings.weekPasswordErrorMessage;
      } else if (error.code == AppStrings.emailAlreadyUsedCode) {
        message = AppStrings.emailAlreadyUsedMessage;
      } else {
